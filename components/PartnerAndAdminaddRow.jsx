                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">
                      ...
                      >
                        ...
                        <div className="mb-4 w-[70%] text-center">
                          <label className="block text-sm font-bold mb-3 text-left ml-12 mt-10">
                            Name
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="mb-6x w-[70%] text-center">
                          ...
                          <div className="flex items-center relative left-[40px]">
                            ...
                            <input
                              ...
                              className={`w-[80%] border border-gray-400 rounded-md py-3 outline-none mb-3 pl-12 number-input ${
                        ...
                        <div className="flex flex-row lg:flex-row w-[80%] justify-center sm:w-full mb-7 pt-5">
                        ...
                        <div className="flex flex-row sm:flex sm:justify-end">
                          {isPartnerDesign && (
                            <button
                              ...
                              className="px-12 py-2 bg-theme rounded text-white mr-12 md:mb-0 hover:bg-darkTheme"
                            >
                              Add
                            </button>
                          )}
                          ...
                          <button
                            type="button"
                            className="relative focus:outline-none px-12 py-2 border-secondaryColor rounded text-secondaryColor border hover:bg-secondaryColor hover:text-white"
                            onClick={() => setOpen(false)}
                          >
                            Close
                          </button>
